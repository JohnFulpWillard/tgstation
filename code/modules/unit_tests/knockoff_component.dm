...
/datum/unit_test/knockoff_component/Run()
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] == glasses, "Dummy failed to equip the glasses.")
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] == glasses, "Dummy lost their glasses even thought they were disarmed targeting the wrong slot.")
	...
	shoves_the_guy.disarm(wears_the_glasses)
	TEST_ASSERT(!wears_the_glasses.IsKnockdown(), "Dummy was knocked down when being disarmed shouldn't have been.")
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] != glasses, "Dummy kept their glasses, even though they were shoved targeting the correct zone.")
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] != glasses, "Dummy kept their glasses, even though they knocked down by Knockdown().")
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] != glasses, "Dummy kept their glasses, even though they knocked down by AdjustKnockdown().")
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] != glasses, "Dummy kept their glasses, even though they knocked down by SetKnockdown().")
	...
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] == glasses, "Dummy lost their glasses, even though AdjustKnockdown() was called with a negative value.")
	...
	shoves_the_guy.zone_selected = BODY_ZONE_CHEST
	shoves_the_guy.disarm(wears_the_glasses)
	TEST_ASSERT(wears_the_glasses.equipped_items_by_slot["[ITEM_SLOT_EYES]"] != glasses, "Dummy kept their glasses, even though were disarm shoved into a wall.")
...
/datum/unit_test/knockoff_component/proc/set_glasses_wearer(mob/living/carbon/human/wearer, turf/reset_to, obj/item/clothing/glasses/reset_worn)
	...
	if(!wearer.equipped_items_by_slot["[ITEM_SLOT_EYES]"])
