...
/proc/get_location_accessible(mob/located_mob, location)
	...
	if(iscarbon(located_mob))
		...
		for(var/obj/item/clothing/clothes in list(
			clothed_carbon.equipped_items_by_slot["[ITEM_SLOT_BACK]"],
			clothed_carbon.equipped_items_by_slot["[ITEM_SLOT_MASK]"],
			clothed_carbon.equipped_items_by_slot["[ITEM_SLOT_HEAD]"]))
		...
		if(ishuman(clothed_carbon))
			...
			for(var/obj/item/clothes in list(
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_OCLOTHING]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_ICLOTHING]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_FEET]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_BELT]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_GLOVES]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_EYES]"],
				clothed_human.equipped_items_by_slot["[ITEM_SLOT_EARS]"]))
				covered_locations |= clothes.body_parts_covered
				face_covered |= clothes.flags_inv
				eyesmouth_covered |= clothes.flags_cover
