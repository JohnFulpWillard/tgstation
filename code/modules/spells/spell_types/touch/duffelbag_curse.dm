...
/datum/action/cooldown/spell/touch/duffelbag/cast_on_hand_hit(obj/item/melee/touch_attack/hand, mob/living/carbon/victim, mob/living/carbon/caster)
	...
	if(istype(victim.equipped_items_by_slot["[ITEM_SLOT_BACK]"], /obj/item/storage/backpack/duffelbag/cursed))
	...
	if(victim.dropItemToGround(victim.equipped_items_by_slot["[ITEM_SLOT_BACK]"]))
