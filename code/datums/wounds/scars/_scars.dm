...
/datum/scar/proc/is_visible(mob/viewer)
	...
	if(istype(limb, /obj/item/bodypart/head))
		if((human_victim.equipped_items_by_slot["[ITEM_SLOT_MASK]"] && (human_victim.equipped_items_by_slot["[ITEM_SLOT_MASK]"].flags_inv & HIDEFACE)) || (human_victim.equipped_items_by_slot["[ITEM_SLOT_HEAD]"] && (human_victim.equipped_items_by_slot["[ITEM_SLOT_HEAD]"].flags_inv & HIDEFACE)))
			return FALSE
