...
/turf/open/lava/proc/can_burn_stuff(atom/movable/burn_target)
	...
	if(iscarbon(burn_living))
		...
		var/obj/item/clothing/burn_suit = burn_carbon.equipped_items_by_slot["[ITEM_SLOT_OCLOTHING]"]
		var/obj/item/clothing/burn_helmet = burn_carbon.equipped_items_by_slot["[ITEM_SLOT_HEAD]"]
